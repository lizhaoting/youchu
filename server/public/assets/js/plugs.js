...
$(function() {
    ...
    $('.layout[data-bg_image_parallax="true"]').each(function(i, e) {
        new Parallax({
            scrollBox: window,
            container: e,
...
//         init() {
//             if (!this.option.doms_class) return false;
//             this.watch_doms.on("animationend", function() {
...
//         animate() {
//             requestAnimationFrame(() => {
//                 this.watch_doms.each((i, e) => {
//                     if (
//                         !$(e).hasClass("inview_show") &&
//                         this.t_check_in_view(e)
//                     ) {
//                         $(e)
//                             .addClass("animated")
//                             .addClass("inview_show");
//                     }
//                     // else {
//                     //     this.watch_doms.removeClass("inview_show");
//                     // }
//                 });
//                 if (this.watch_doms.filter(".col:not(.inview_show)").length) {
//                     this.animate();
//                 }
//             });
//         }
...
//     new IinView({
//         doms_class:
//             ".postbody .layout_limit_wrapper[data-animate] .layout_header, .layout_limit_wrapper[data-animate] .layout_footer, .postbody .layout_limit_wrapper[data-animate] .col"
//     }).init();
//     // new IinView({
//     //     doms_class: ".layout_limit_wrapper[data-animate] .layout_footer"
//     // }).init();
//     // new IinView({
//     //     doms_class:
//     //         ".postbody .layout_limit_wrapper[data-animate] .layout_header"
//     // }).init();
// });
...
$(function() {
    var wow = new WOW({
        boxClass:
            "layout_limit_wrapper[data-animate] .col, .layout_limit_wrapper[data-animate] .layout_header, .layout_limit_wrapper[data-animate] .layout_footer", // default
...
$(function() {
    $(
        '#layout[data-alter="slider_editor"] .ck-content[data-alter="slider_editor"]'
    ).each(function(i, el) {
        var showIndex = $(this).attr("data-slider-slidesToShow"); // 一屏显示个数
        var autoplay = Boolean(
            parseFloat($(this).attr("data-slider-autoplay"))
        ); // 是否自动播放
        var isVertical = Boolean(
            parseFloat($(this).attr("data-slider-vertical"))
        ); // 是否垂直滚动
        var paddingVel = $(this).attr("data-slider-centerPadding"); // 每项间距
        var fade = Boolean(parseFloat($(this).attr("data-slider-fade"))); // 是否过渡
        var adaptiveHeight = Boolean(
            parseFloat($(this).attr("data-slider-adaptiveHeight"))
        ); // 是否自适应高度
...
window.onload = function() {
    $(
        ...
        $(".image img", el).each(function() {
            var _width = $(".image img", el).width();
            var _height = $(".image img", el).height();
            $(this).css({
                width: _width,
                height: _height
            });
